        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-light border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action bg-light" href="#!">Daftar Pasien</a>
                    <a class="list-group-item list-group-item-action bg-light" href="#!">Daftar BMI Pasien</a>
                </div>
            </div>
            <!-- Page Content-->
